...
<form class="form-horizontal" onsubmit="return getData();" action="${pageContext.request.contextPath}/essay/updateSave"
...
<%--                    <label><input type="radio" name="status" value="3">随便看看</label>--%>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11">
            <button type="submit" class="btn btn-default glyphicon glyphicon-pencil"> 修改</button>
        </div>
    </div>
</form>
